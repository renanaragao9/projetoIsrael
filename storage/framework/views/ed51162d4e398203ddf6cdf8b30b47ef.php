...
<head>
    ...
    <title><?php echo $__env->yieldContent('Israel Training'); ?></title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="sidebar-heading">
             ...
             <!-- Nav Item - Alunos -->
             <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('alunos')); ?>">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo e(route('cadastro-aluno')); ?>"><i class="fa fa-user"></i>  Aluno</a>
                        <a class="collapse-item" href="<?php echo e(route('cadastro-exercicio')); ?>"><i class="fa fa-dumbbell"></i>  Exercicio</a>
                        <a class="collapse-item" href="<?php echo e(route('cadastro-gm')); ?>"><i class="fa fa-dumbbell"></i>  Grupo muscular</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo e(route('tabela-aluno')); ?>"><i class="fa fa-users"> </i> Alunos</a>
                        <a class="collapse-item" href="<?php echo e(route('tabela-exercicio')); ?>"><i class="fa fa-dumbbell"></i> </i>   Exercicios</a>
                        <a class="collapse-item" href="<?php echo e(route('tabela-gm')); ?>"><i class="fa fa-dumbbell"></i>Grupo muscular</a>
            ...
            <!-- Nav Item - Gráficos -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('graficos')); ?>">
            ...
            <!-- Nav Item - Chamados -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('chamados')); ?>">
...
</html><?php /**PATH C:\laragon\www\projetoIsrael\resources\views/templates/leyout.blade.php ENDPATH**/ ?>